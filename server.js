...
// ================================================================
let plugins = [
  { id: "dart-runner",  name: "Dart Runner",  extensions: ["dart"],         action: "RUN", price: 0,    description: "Execute arquivos Dart no editor", published: true  },
  { id: "python-exec",  name: "Python Exec",  extensions: ["py","python"],  action: "RUN", price: 0,    description: "Execute scripts Python",          published: true  },
  { id: "js-runner",    name: "JS Runner",    extensions: ["js","ts"],      action: "RUN", price: 1.99, description: "Execute JavaScript e TypeScript",  published: false },
];
// ================================================================
